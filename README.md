...
A token is used as a way to manage access, and store important information

- [X] What steps can you take in your web apps to keep your data secure?

You can encrypt data, test the data thats being inputted, store it in a token, you should salt it before encrypting it.

- [X] Describe how web servers work.

Web servers are large computers that are capable of handling requests from many users at once. You can pay to rent someone elses server to host your web apps, or you could invest in your own server.


- [X] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

You would use POST to create the data you would use GET to read the data, you would use PUT to update the data, and of course delete is DELETE. 
